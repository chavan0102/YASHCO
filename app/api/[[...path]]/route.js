...
async function seedIfNeeded() {
  ...
  if (!settings) {
    await database.collection('settings').insertOne({
      ...
      heroEyebrow: 'Season 01 — Nocturne',
      nav: { shop: 'Shop', women: 'Women', men: 'Men', accessories: 'Accessories', concierge: 'Concierge' },
      collectionsEyebrow: 'Curated Collections',
      collectionsTitle: 'A house, quietly assembled.',
      collectionsExploreLabel: 'Explore →',
      shopEyebrow: 'The Boutique',
      shopAllTitle: 'Shop All',
      featuredEyebrow: 'The Edit',
      featuredTitle: 'Signature Pieces',
      featuredCtaLabel: 'View All →',
      aboutEyebrow: 'Maison',
      conciergeCtaTitle: 'Bespoke, on request.',
      conciergeCtaLabel: 'Request a Consultation',
      footer: { boutiqueHeading: 'Boutique', maisonHeading: 'Maison', contactHeading: 'Contact' },
